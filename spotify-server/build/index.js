...
class SpotifyServer {
    ...
    async handleSetAuthCode(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Authentication failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    ...
    async handleGetPlaylists() {
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get playlists: ${error.message || 'Unknown error'}`);
        }
    }
    async handleGetPlaylistTracks(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get playlist tracks: ${error.message || 'Unknown error'}`);
        }
    }
    async run() {
